...
import com.uknown.kelompok8_project_akhir_8.homepage.adapter.BusAdapter;
...
public class ChooseBusActivity extends AppCompatActivity implements BusAdapter.listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new BusAdapter(busModelList, this, getApplicationContext());
                ...
                .get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.getResult().size() > 0){
                            ...
                            addListBusWhenBusisNotYet((harga-30000<0) ? 15000: harga, "16.00", "MLM0091", "ALS", date, departune.getTerminal(), arrival.getTerminal(), "https://asset.kompas.com/crops/oPsmUEDVltVbkqkmWLZkwl15XCU=/0x24:600x424/1200x800/data/photo/2020/10/18/5f8b27154b6dc.png", bookedseat);
                            ...
                            Toast.makeText(getApplicationContext(), "Bus was found", Toast.LENGTH_SHORT).show();
